...
import { BaseMongoRepository, Before, MongoEntityRepository, InjectClient, InjectCurrentTenant, InjectDb, TenantData } from '@juicycleff/nest-multi-tenant';
import { ProjectEntity } from '../entities';

@Injectable()
@MongoEntityRepository({ name: 'project' })
