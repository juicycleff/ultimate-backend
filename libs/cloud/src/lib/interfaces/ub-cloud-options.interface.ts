...
export type RegistryConfiguration = ConsulRegistryProviderOptions | LocalRegistryProviderOptions;
...
export interface UBCloudOptionsFactory {
  createUBCloudOptions():
    | Promise<UBCloudOptions>
    | UBCloudOptions;
}
 ...
 */
export interface UBCloudAsyncOptions
  ...
  useFactory?: (
    ...args: never[]
  ) => Promise<UBCloudOptions> | UBCloudOptions;
